...
class RSVP extends Model{
    ...
    public function __construct($user = ''){
        ...
        $this->validation_rules = array(
            ...
            'attending' => array('rule'=>'string,required','fieldname'=>'Phone Number'),
            'names_attending' => array('rule'=>'string','fieldname'=>'Names of Attendees'),
    ...
    public function create(){        
        ...
        $stmt->bind('attending',$this->attending,'string');
